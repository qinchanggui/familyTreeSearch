...
const PersonCard = ({ 
    ...
    return (
        <div 
            id={`person-${person.id}`} 
            className={`group bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm hover:shadow-md transition-all duration-300 border ${isRelated ? 'border-l-4 border-l-blue-300 border-t-gray-100 border-r-gray-100 border-b-gray-100 dark:border-l-blue-600 dark:border-t-gray-700 dark:border-r-gray-700 dark:border-b-gray-700' : 'border-gray-100 dark:border-gray-700 hover:border-blue-100 dark:hover:border-blue-800'} relative overflow-hidden`}
        >
            ...
            <div className="relative">
                <div className="flex items-center gap-3 mb-3">
                    <div className={`p-2 rounded-lg ${isRelated ? 'bg-gray-50 group-hover:bg-gray-100 dark:bg-gray-700 dark:group-hover:bg-gray-600' : 'bg-blue-50 group-hover:bg-blue-100'} transition-colors duration-300`}>
                        <UserIcon className={`h-5 w-5 ${isRelated ? 'text-gray-400' : 'text-blue-600'}`} />
                    </div>
                    {isRelated && <span className="text-[10px] text-blue-500 dark:text-blue-400 bg-blue-50 dark:bg-blue-900/30 px-1.5 py-0.5 rounded">关联</span>}
                    <h3
